...
export class ConfirmComponent implements OnInit {
  ...
  resendCode() {
    ...
    this.authService
      .resendSignUp(this.formControls.username.value)
      .then(() =>
        this.snackBar.open('Wir haben dir einen neuen Link zugesendet.', '', {
          duration: 3000,
        })
      )
      .catch(() =>
        this.snackBar.open(
          'Leider ist etwas schiefgelaufen. Versuche es später nochmal.',
          '',
          { duration: 3000 }
        )
      )
